...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-ink">
        ...
        <section id="results" className="px-6 py-16 animate-fade-in">
          <div className="mx-auto max-w-3xl">
            ...
            <h2 className="mb-10 font-serif text-2xl italic text-offwhite">
              Here's what the documents are worth to your contractor right now.
            </h2>
      ...
      {hasCalculated && output && (
        <section className="px-6 py-16 animate-fade-in">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mb-10 text-sm text-mist">
              Every practice below represents a document-quality check your team can run before bid. Toggle each one you've actually done — the exposure number updates as you go.
            </p>
            <MitigationPanel
              output={output}
      ...
      {/* Section E — Floor message + email capture */}
          ...
          <div className="mx-auto max-w-3xl">
            ...
            >
              ...
              <p className="mb-6 text-sm leading-relaxed text-mist">
                Below this line is residual risk — the exposure that your design team cannot catch on its own, no matter how many document quality practices you run. It requires an outside read of the documents the way your contractor will read them. Before bid day.
              </p>
              <p className="mb-8 text-sm leading-relaxed text-mist">
                That's the gap Preempt Global closes.
              </p>
              <div className="mb-10">
                ...
                <div className="font-serif text-3xl italic text-gold-light md:text-4xl">
                  {output
                    ? `$${(output.residualLow / 1_000_000).toFixed(2)}M – $${(output.residualHigh / 1_000_000).toFixed(2)}M`
                    : '—'}
                </div>
              </div>
      ...
      {/* Section F — About Preempt Global */}
      <section className="px-6 py-20 border-t border-ink-2">
        <div className="mx-auto max-w-3xl">
          <div className="mb-3 text-xs uppercase tracking-widest text-gold">
            Preempt Global
          </div>
          ...
          <p className="mb-8 text-sm leading-relaxed text-mist max-w-xl">
            If the number above made you pause, and your project is heading to bid in the next 90 days, that's the right time to talk.
          </p>
      ...
      <footer className="border-t border-ink-2 px-6 py-8">
        <div className="mx-auto max-w-3xl flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div className="text-xs text-mist">
            ...
            . © {new Date().getFullYear()} Preempt Global LLC. All rights reserved.
          </div>
